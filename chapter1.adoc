...
O vídeo abaixo é uma apresentação sobre a ferramenta Scratch (apresentada anteriormente), que é bastante utilizada para ensinar crianças a programar, principalmente pela criação de jogos. O vídeo abaixo inicia nos 13 minutos, mas vale a pena assistir do início. *Ative as legendas e veja as várias lições a serem aprendidas.*

video::Ok6LbV6bqaE[youtube, start="13:26", width=640, height=480, title="Aprender a elaborar algoritmos vai muito além de criar programas."]
